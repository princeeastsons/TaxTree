import {
    ...
    Text, View, TouchableWithoutFeedback, ScrollView, TextInput, Platform, TouchableOpacity, KeyboardAvoidingView, Keyboard, ImageBackground, Image, SafeAreaView, Alert
} from 'react-native'
...
const ClientSteps = () => {
    ...
    const labels = ["ABOUT YOURSELF", "REFERRAL SOURCE", "ASSOCIATIONS", "CURRENT PROFESSION", "ARE YOU INTRESTED IN ANY OF THE BELOW"];
    const labels1 = ["ABOUT YOURSELF", " ", " ", "  ", " "];
    const labels2 = [" ", "REFERRAL SOURCE", " ", "  ", " "];
    // const labels3 = ["", " ", "PAYMENT METHOD", "  ", " "];
    const labels3 = ["", " ", "ASSOCIATIONS", " ", ""];
    const labels4 = ["", " ", " ", "CURRENT PROFESSION", ""];
    const labels5 = ["", " ", " ", "  ", "INTERESTS"];
                    ...
                    <View style={{ flex: 1 }}>
                        ...
                        <View style={{ width: wp(90), alignSelf: 'center' }}>
                            ...
                            <StepIndicator
                                ...
                                labels={position == 0 ? labels1 : position == 1 ? labels2 : position == 2 ? labels3 : position == 3 ? labels4 : position == 4 ?
                                    labels5 : position == 5
                                            ...
                                            <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
                                                ...
                                                <View style={styles.subContainer1}>
                                                    ...
                                                    <View style={{ width: wp(80), flexDirection: 'row', justifyContent: 'space-between' }}>
                                                        ...
                                                        <TouchableOpacity style={styles.btn} onPress={() => { onPageChange4(3) }}>
                                                            {/* <Icon
                                            style={[
                                                styles.icon,
                                                {
                                            ...
                                            <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
                                                        ...
                                                        {professionOption != 2 ?
                                                            ...
                                                            >
                                                                <TextInput
                                                                    ...
                                                                    // placeholderTextColor={'lightgrey'}
                                                                    style={{
                                                                        color: Color.HeaderBackground, fontFamily: 'Poppins-SemiBold', fontSize: 12, width: wp(85),
                                                                        alignSelf: 'center',
                                                                        paddingTop: 10, paddingLeft: 10, height: 50, textAlignVertical: 'top', borderColor: Color.headerIconBG, borderWidth: 1
                                                                    }}
                                                                    value={profession}
                                                ...
                                                :null }   */}
                                                    ...
                                                    <View style={{ width: wp(80), flexDirection: 'row', justifyContent: 'space-between' }}>
                                                        ...
                                                        <TouchableOpacity style={styles.btn} onPress={() => { onPageChange5(4) }}>
                                                            {/* <Icon
                                            style={[
                                                styles.icon,
                                                {
